...
Each needs 80% to unlock the next. Best scores are kept, so a bad rerun never
takes away a level you already earned.
...
26 checks in a real browser. It reads the actual SEP 119 and ZUL 119 PDFs
